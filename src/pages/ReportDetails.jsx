...
// Nutrition fields shown in the review grid
...
export default function ReportDetails() {
  ...
  return (
    <DashboardLayout>
      ...
      <h1 className="page-title details-title">
        Report Details
      </h1>
      ...
      <div className="details-card">
        ...
        <div className="details-header-block">
          ...
          <div className="details-meta-row">
            ...
            <div className="details-meta-item details-meta-status">
              <span className="details-label">
                Status
              </span>
        ...
        <div className="details-photos">
          ...
          <div className="photo-box">
            <span className="photo-box-label">
              Front Photo
            </span>
            ...
            {report.frontImageUrl ? (
              <img
                ...
                onClick={() =>
                  setLightbox(report.frontImageUrl)
                }
              />
            ) : (
          ...
          <div className="photo-box">
            ...
            {report.backImageUrl ? (
              <img
                ...
                onClick={() =>
                  setLightbox(report.backImageUrl)
                }
              />
            ) : (
              <div className="photo-box-empty">
        ...
        {report.additionalBackImageUrls &&
          report.additionalBackImageUrls.length > 0 && (
            <div className="details-photos">
              ...
              <div className="photo-box additional-photos">
                ...
                <div className="additional-photos-grid">
                  {report.additionalBackImageUrls.map(
                    (url, index) => (
                      <div
                        key={index}
        ...
        <div className="extraction-section">
          ...
          {!hasExtraction && (
            <p className="extraction-pending-note">
              No extraction data yet -- this may still be
              processing in the background, or extraction
              failed. You can fill in the fields below
              manually using the photos above.
            </p>
          )}
          ...
          {/* =====================================================
              ...
              LEFT  = Product Data + Allergen Guide
              RIGHT = Nutrition + Allergen Selection
              ===================================================== */}

          <div className="extraction-content-grid">

            {/* =================================================
                LEFT COLUMN
                ================================================= */}
            <div className="extraction-product-column">
              ...
              <div className="field-group">
                ...
                <label className="field-label">
                  Ingredients (one per line, in label order)
                </label>
              ...
              <div className="field-group allergen-section">

                <label className="field-label">
                  Allergens
                </label>

                <div className="allergen-guide allergen-guide-expanded">
                  ...
                  <table className="allergen-table">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th>
                          Derivatives & Related Ingredients
                        </th>
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Milk</td>
                        <td>
                          Milk, dairy, cream, cheese,
                          yogurt, butter, lactose, casein,
                          whey
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          lobster, squid, clams, mussels,
                          oysters, scallops, octopus,
                          crustacean
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td>Soy</td>
                        <td>
                          Soy, soya, soybean, tofu, tempeh,
                          tamari, shoyu, edamame, miso,
                          natto, okara
                        </td>
                      </tr>
            ...
            {/* =================================================
                RIGHT COLUMN
                NUTRITION + ALLERGEN SELECTION
                ================================================= */}
            <div className="extraction-nutrition-column">

              {/* NUTRITION */}

              <div className="field-group nutrition-section">
              ...
              {/* =================================================
                  ...
                  IMPORTANT:
                  This is now in the SAME COLUMN as Nutrition.
                  ================================================= */}
